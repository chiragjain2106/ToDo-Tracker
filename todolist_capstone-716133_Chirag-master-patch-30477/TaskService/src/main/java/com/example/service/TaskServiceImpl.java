    ...
    public User addTask(String email,Task task) {
        ...
        if(user!=null){
            if(user.getTaskList()==null){
                ...
                System.out.println("task date : "+task.getDate());
                System.out.println("check condition task date not equal to current date : "+!task.getDate().equals(date));
                if(!task.getDate().equals(date)) {
                    System.out.println("setting date inside if : " + task.getDate().plusDays(1));
    ...
    public User updateTask(String email, int taskId,Task task) throws UserNotFoundException {
        ...
        if(user==null){
            ...
            System.out.println(task1);
                ...
                LocalDate date =LocalDate.now();
                    System.out.println("task date : "+task.getDate());
                    System.out.println("task date : "+task1.getDate());
                    System.out.println("check condition task date not equal to current date : "+!task.getDate().equals(task1.getDate()));
...
//                System.out.println("Task not found");
        ...
        System.out.println("task removed : "+taskList);
         taskRepo.save(user);
        return taskList;
    }
    ...
    @Override
    public User setTaskColor(String email, int taskId, String color) throws UserNotFoundException {
        User user = taskRepo.findByEmail(email);
        Task t =null;
        if(user==null){
            throw new UserNotFoundException();
